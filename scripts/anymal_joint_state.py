...
class Anymal_runner(object):
    ...
    def setup(self) -> None:
        ...
        self.setup_ros2_odom_graph()
        self.setup_ros2_joint_state_graph()
    ...
    def setup_ros2_odom_graph(self):
        graph_path = "/Graph/ROS_Odometry"
        chassis_prim = "/World/Anymal/base"
        ...
        og.Controller.edit(
            {"graph_path": graph_path, "evaluator_name": "execution"},
            {
                ...
                og.Controller.Keys.SET_VALUES: [
                    ...
                    ("PublishOdom.inputs:chassisFrameId", "base"),
                ],
    ...
    def setup_ros2_joint_state_graph(self):
        graph_path = "/Graph/ROS_JointStates"
        target_prim = "/World/Anymal/base"
        ...
        og.Controller.edit(
            {"graph_path": graph_path, "evaluator_name": "execution"},
            {
                ...
                og.Controller.Keys.SET_VALUES: [
                    ...
                    ("PublishJointState.inputs:targetPrim", [usdrt.Sdf.Path(target_prim)]),
                ],
                og.Controller.Keys.CONNECT: [
